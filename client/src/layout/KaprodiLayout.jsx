        ...
        {isDesktop ? (
          <Sidebar>
            ...
            <SidebarItem
              icon={<Repeat />}
              text="Konversi"
              active={path === "/kaprodi/konversi"}
              alert={pendingStatus(data)}
              path={"/kaprodi/konversi"}
            />
            <SidebarItem
              icon={<History />}
              text="Riwayat Konversi"
              active={path === "/kaprodi/riwayat"}
              path={"/kaprodi/riwayat"}
            />
            <SidebarItem
              icon={<Users />}
              text="Mahasiswa"
              active={path === "/kaprodi/mahasiswa"}
              path={"/kaprodi/mahasiswa"}
            />
            <SidebarItem
              icon={<User />}
              text="Pengguna"
              active={path === "/kaprodi/pengguna"}
              path={"/kaprodi/pengguna"}
            />
            <SidebarItem
              icon={<Logs />}
              text="Mata Kuliah"
              active={path === "/kaprodi/matakuliah"}
              path={"/kaprodi/matakuliah"}
            />
            <SidebarItem
              icon={<Briefcase />}
              text="Pimpinan"
              active={path === "/kaprodi/pimpinan"}
              path={"/kaprodi/pimpinan"}
            />
          </Sidebar>
        ) : (
