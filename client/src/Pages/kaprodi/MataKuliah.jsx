...
function Pengguna() {
  ...
  const handleAction = async (e, actionType) => {
    ...
    if (actionType === "edit") {
      const selectedProperties = useSelectedProperties(dataMk, [
        "id_mk",
        "mata_kuliah",
        "sks",
        "semester",
      ...
      dispatch(
        updateData({
          endpoint: `matakuliah/update/${dataMk.id_mk}`,
          data: updatedData,
        })
      );
      setIsModalEdit(false);
    ...
    <>
      ...
      <Modal className={"w-fit"} open={isModalTambah}>
        ...
        >
          <Input.TextInput
            ...
            type={"text"}
            onChange={(e) => {
              handleInputValue(e, "id_mk", "tambah");
            }}
          />
          <Input.TextInput
            label={"Mata Kuliah"}
            ...
            type={"text"}
            onChange={(e) => {
              handleInputValue(e, "mata_kuliah", "tambah");
            }}
          />
          <Input.SelectInput
            label={"SKS"}
          ...
          <Input.SelectInput
            ...
            onChange={(e) => {
              handleInputValue(e, "semester", "tambah");
            }}
          />
        </Modal.ModalCustom>
      </Modal>
      <Modal className={"w-fit"} open={isModalEdit}>
        ...
        >
          ...
          <Input.TextInput
            ...
            width={"full"}
            type={"text"}
            value={dataMk.mata_kuliah}
            onChange={(e) => {
              handleInputValue(e, "mata_kuliah", "edit");
            }}
            reference={mkRef}
          />
          <Input.SelectInput
          ...
          <Input.SelectInput
            label={"Semester"}
            selected={dataMk.semester}
            width={"full"}
            value={["1", "2", "3", "4", "5", "6", "7", "8"]}
            onChange={(e) => {
              handleInputValue(e, "semester", "edit");
            }}
      ...
      <Modal open={isDeleteModal}>
        <Modal.ModalCustom
          ...
          title={`Apakah anda yakin ingin menghapus Mata Kuliah '${dataMk.mata_kuliah}'?`}
