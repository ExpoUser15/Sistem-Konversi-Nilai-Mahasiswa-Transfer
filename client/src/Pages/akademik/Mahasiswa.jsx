...
function Mahasiswa() {
    ...
    useEffect(() => {
        dispatch(fetchData({ endpoint: 'mahasiswa' }));
    }, [dispatch]);
    ...
    const handleInputValue = async (e, item, action, file) => {
        ...
        const addData = {
            ...value,
            [item]: !file ? inputvalue : await useCompressedImage(e)
        }
        setValue(addData);
    }
    ...
    return (
        <>
            ...
            <div className='mb-16 bg-white px-8 py-3 rounded-md shadow dark:bg-black dark:shadow-neutral-700'>
                ...
                <Tables fields={["No", "Nama", "Tanggal", "Email", "Berkas", "Transkrip", "Surat Pindah", "Detail", "Status", ""]} gap={"5"}>
                    {
                        students.length > 0 ?
                            students
                                ...
                                .map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div
                                            className='flex'
                                            onClick={() => openModal('edit', pengajuan[index])}
                                        >
